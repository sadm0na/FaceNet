...
from tensorflow.keras.layers import MaxPooling2D, AveragePooling2D, Dropout, Flatten, Dense
import fr_utils
...
def faceRecoModel(input_shape):
    ...
    # L2 normalization
    X = Lambda(lambda x: tf.linalg.normalize(x, axis=1)[0], output_shape=lambda s: s)(X)
